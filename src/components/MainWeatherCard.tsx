        ...
        <div className="bg-white shadow-2xl flex-1 flex flex-col justify-center items-center p-8 min-h-[28rem]">
            ...
            <div className="flex justify-center mb-12">
                <div className="relative w-40 h-40 flex items-center justify-center">
                    <WeatherIcon icon={weatherData?.icon || "cloud"} size={160} />
                </div>
            </div>

            <div className="text-center">
                <div className="text-7xl font-light text-gray-800 mb-3">
                    {weatherData?.temperature.toFixed(1) || "0"}°
                </div>
                <div className="text-gray-500 text-xl mb-2">
                    {weatherData?.condition || "N/A"}
                </div>
                <div className="text-gray-400 text-lg mb-4">
                    Feels like {weatherData?.feelsLike.toFixed(1) || "0"}°
                </div>
                <div className="flex justify-center gap-6 text-sm text-gray-500">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span>{weatherData?.windSpeed.toFixed(1) || "0"} km/h</span>
                    </div>
                </div>
            </div>
        </div>
